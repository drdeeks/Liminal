...
if (!chainId) {
    console.error('Please provide a chain ID as an argument.');
    process.exit(1);
}
const broadcastPath = path.resolve(__dirname, `contracts/broadcast/DeployMonad.s.sol/${chainId}/run-latest.json`);
