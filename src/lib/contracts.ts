...
const BASE_LEADERBOARD_ADDRESS = (import.meta.env.VITE_BASE_LEADERBOARD_ADDRESS || '0x0000000000000000000000000000000000000000') as `0x${string}`
const MONAD_GMR_ADDRESS = (import.meta.env.VITE_MONAD_GMR_ADDRESS || '0x227432663102E95AE51A13118A5de5a664039bEc') as `0x${string}`
const BASE_GMR_ADDRESS = (import.meta.env.VITE_BASE_GMR_ADDRESS || '0x0000000000000000000000000000000000000000') as `0x${string}`
...
const BASE_RESET_STRIKES_ADDRESS = (import.meta.env.VITE_BASE_RESET_STRIKES_ADDRESS || '0x0000000000000000000000000000000000000000') as `0x${string}`
